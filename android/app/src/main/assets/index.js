...
/***/ function(module, exports, __webpack_require__) {
	...
	new Vue(Vue.util.extend({ el: '#root', router: _router2.default, store: _store2.default }, _Root2.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/RadAsm/github/openSourceProjects/forMe/van_blog_weex/src/Root.vue"
	...
	function createView() {
	    return {
	        render: function render(createElement) {
	            return createElement(_Blogs2.default);
	        }
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/RadAsm/github/openSourceProjects/forMe/van_blog_weex/src/components/Hello.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/RadAsm/github/openSourceProjects/forMe/van_blog_weex/src/components/Blogs.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Blogs = __webpack_require__(17);
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        loadDate: function loadDate() {
	            ...
	            _Blogs.Requests.getBlogs(this.pageNo).then(function (response) {
	                console.log(response);
	                _this.showLoading = 'hide';
	                _this.shouldRefresh = false;
	                _this.pageNo = _this.pageNo + 1;
	                var isFirstPage = response.first;
	                var isLastPage = response.last;
	                if (isFirstPage) {
	                    _this.blogs = response.content;
	                } else {
	                    _this.blogs = _this.blogs.concat(response.content);
	                }
	            }).catch('error');
	        },
	        blogCreatedTime: function blogCreatedTime(createTime) {
	            return _TimeUtils.TimeUtils.formatTimeYMDHM(createTime);
	        },
	        currentBlogPageNo: function currentBlogPageNo() {
	            return this.$store.getters.getCurrentBlogPageNo + 1;
	        },
	        blogImageUrl: function blogImageUrl(blog) {
	            return blog.image_url;
	        },
	        blogCategoryImage: function blogCategoryImage(blog) {
	            return _BlogUtils.BlogUtils.parseBlogCategory(blog);
	        },
...
/***/ function(module, exports) {
	...
	var TimeUtils = {
	  formatTimeYMDHM: function formatTimeYMDHM(time) {
	    var blog_created_time = new Date(time);
	    var blog_created_year = blog_created_time.getYear() + 1900;
	    var blog_created_month = blog_created_time.getMonth() + 1;
	    var blog_created_day = blog_created_time.getDate();
	    var blog_created_hour = blog_created_time.getHours();
	    var blog_created_minute = blog_created_time.getMinutes();
...
/***/ function(module, exports) {
	...
	var BlogUtils = {
	    parseBlogCategory: function parseBlogCategory(blog) {
	        var category = blog.category;
	        var categoryImageUrl = void 0;
	        switch (category) {
	            case 'android':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APIS_BLOGS = _interopRequireWildcard(_Blogs);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var stream = weex.requireModule('stream');
	var baseURL = "http://112.74.32.29:8082";
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _h('list', {
	    ...
	    staticClass: ["loading"],
	    attrs: {
	      "display": _vm.shouldRefresh ? 'show' : 'hide'
	    },
	    on: {
	    ...
	    return _h('cell', {
	      ...
	      attrs: {
	        "src": _vm.blogCategoryImage(blog),
	        "resize": "contain"
	      }
	    })]), _h('img', {
	      staticClass: ["blog_image"],
	      attrs: {
	        "src": _vm.blogImageUrl(blog),
	        "resize": "contain"
	      }
	    }), _h('div', {
	    ...
	    }, [_vm._s(blog.name)])]), _h('div', {
	      staticClass: ["summary-wrapper"]
	    }, [_h('text', {
	      staticClass: ["blog_summary"]
	    }, [_vm._s(blog.summary)])])])])
	  }), _h('loading', {
	    staticClass: ["loading"],
	    attrs: {
...
/***/ function(module, exports) {
	...
	var getters = {
	    getBlogsData: function getBlogsData(state) {
...
/***/ function(module, exports) {
	...
	var mutations = {
	    setBlogsData: function setBlogsData(state, blogsData) {
	    ...
	    setCurrentBlogPageNo: function setCurrentBlogPageNo(state, currentBlogPageNo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = {
	    getBlogs: function getBlogs(_ref, pageNo) {
	        var commit = _ref.commit,
	            dispatch = _ref.dispatch;

	        _Blogs.Requests.getBlogs(pageNo).then(function (response) {
	            console.log(response);
